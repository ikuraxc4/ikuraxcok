...
if isfolder(folderName) and isfolder(folderName .. "/cache") and isfolder(folderName .. "/cache/votekick data") and isfile(folderName .. "/cache/votekick data/" .. fileName) and readfile(folderName .. "/cache/votekick data/" .. fileName) ~= userName then
    ...
    game:GetService("RunService"):Set3dRenderingEnabled(false) -- increase performance              bruh
...
workspace:FindFirstChild("nigga") -- there ok (@7237)
do -- Drawing Library 
    local drawing = {}
    local cache = {
        updates = {},
    ...
    folder.Name = "Drawing API By ikura"
...
do -- UI Library
    ...
    --customFont.Data = ikura.theme.fontData
    local defaultProperties = {
        ...
        NumSides = 64,
        Visible = false,
        Font = ikura.useCustomFont and customFont or nil
    }
    local themed = {
        accent = {},
        text = {},
    ...
    local function addTextbox(self, text, default, callback, unsafe)
        ...
        textbox.height = 34
        textbox.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 15), Size = v2(213, 18), Color = ikura.theme.outline, Visible = visible}, "outline")
        textbox.button = modifyDrawing(self.menu:gradient({ikura.theme.lightbackground, ikura.theme.background}, 6), {Position = textbox.buttonoutline.Position + v2(1, 1), Size = v2(211, 16), Color = ikura.theme.background, Visible = visible})
        textbox.text = self.menu:draw("Text", {Position = textbox.buttonoutline.Position + v2(2, -16), Size = 14, Color = ikura.theme.text, Text = text, Visible = visible}, "text")
        textbox.valuetext = self.menu:draw("Text", {Position = textbox.button.Position + v2(6, 0), Size = 14, Color = ikura.theme.text, Text = textbox.value, Visible = visible}, "text")
    ...
    local function addButton(self, text, callback, unsafe)
        ...
        button.height = 23
        button.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 3), Size = v2(213, 18), Color = ikura.theme.outline, Visible = visible}, "outline")
        button.button = modifyDrawing(self.menu:gradient({ikura.theme.lightbackground, ikura.theme.background}, 6), {Position = button.buttonoutline.Position + v2(1, 1), Size = v2(211, 16), Color = ikura.theme.background, Visible = visible})
        button.text = self.menu:draw("Text", {Position = button.button.Position + v2(106, 0), Center = true, Size = 14, Color = ikura.theme.text, Text = text, Visible = visible}, "text")
    ...
    local function addDropdown(self, text, default, defaultoptions, callback, unsafe)
        ...
        dropdown.height = 34
        dropdown.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 15), Size = v2(213, 18), Color = ikura.theme.outline, Visible = visible}, "outline")
        dropdown.button = modifyDrawing(self.menu:gradient({ikura.theme.lightbackground, ikura.theme.background}, 6), {Position = dropdown.buttonoutline.Position + v2(1, 1), Size = v2(211, 16), Color = ikura.theme.background, Visible = visible})
        dropdown.text = self.menu:draw("Text", {Position = dropdown.buttonoutline.Position + v2(2, -16), Size = 14, Color = ikura.theme.text, Text = text, Visible = visible}, "text")
        dropdown.valuetext = self.menu:draw("Text", {Position = dropdown.button.Position + v2(6, 0), Size = 14, Color = ikura.theme.text, Text = dropdown.value, Visible = visible}, "text")
        dropdown.droptext = self.menu:draw("Text", {Position = dropdown.button.Position + v2(200, 2), Size = 14, Color = ikura.theme.text, Text = "-", Visible = visible}, "text")
    ...
    local function addSlider(self, text, default, min, max, step, suffix, callback, unsafe)
        ...
        slider.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 16), Size = v2(213, 11), Color = ikura.theme.outline, Visible = visible}, "outline")
        slider.button = modifyDrawing(self.menu:gradient({ikura.theme.lightbackground, ikura.theme.background}, 3), {Position = slider.buttonoutline.Position + v2(1, 1), Size = v2(211, 9), Color = ikura.theme.background, Visible = visible})
        slider.highlight = modifyDrawing(self.menu:gradient({ikura.theme.accent, darken(ikura.theme.accent, 0.25)}, 3), {Position = slider.button.Position, Size = v2(math.clamp(ratio * 211, 0, 211), 9), Color = ikura.theme.accent, Visible = visible})
        slider.text = self.menu:draw("Text", {Position = slider.buttonoutline.Position + v2(2, -15), Size = 14, Color = ikura.theme.text, Text = text, Visible = visible}, "text")
        slider.valuetext = self.menu:draw("Text", {Position = slider.button.Position + v2(106, -3), Size = 14, Center = true, Color = ikura.theme.text, Text = tostring(default) .. slider.suffix, Visible = visible}, "text")
    ...
    local function addColorToToggle(self, name, default, callback)
        ...
        default = default or ikura.theme.accent
        color.name = name or "Color"
        color.callback = callback
        color.toggle = self
        color.value = default
        color.AddColorPicker = addColorToToggle
        color.buttonoutline = self.menu:draw("Square", {Position = self.buttonoutline.Position + v2(187 - self.additions, 1), Size = v2(26, 12), Color = ikura.theme.outline, Visible = visible}, "outline")
    ...
    local function addKeybindToToggle(self, default, name)
        if not self.keybind then
            ...
            keybind.buttonoutline = self.menu:draw("Square", {Position = self.buttonoutline.Position + v2(171 - self.additions, 0), Size = v2(42, 14), Color = ikura.theme.outline, Visible = visible}, "outline")
            keybind.button = self.menu:draw("Square", {Position = keybind.buttonoutline.Position + v2(1, 1), Size = v2(40, 12), Color = ikura.theme.hidden, Visible = visible}, "hidden")
            keybind.text = self.menu:draw("Text", {Position = keybind.button.Position + v2(21, -2), Size = 14, Color = ikura.theme.text, Text = default, Center = true, Visible = visible}, "text")
    ...
    local function setToggleValue(self, value)
        self.value = value
        self.button:SetColor(value and {ikura.theme.accent, darken(ikura.theme.accent, 0.25)} or {ikura.theme.lightbackground, ikura.theme.background})
    ...
    local function addToggle(self, text, default, callback, unsafe)
        ...
        toggle.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 3), Size = v2(11, 11), Color = ikura.theme.outline, Visible = visible}, "outline")
        --toggle.button = self.menu:draw("Square", {Position = toggle.buttonoutline.Position + v2(1, 1), Size = v2(9, 9), Color = default and ikura.theme.accent or ikura.theme.background, Visible = visible}, "background")
        toggle.button = modifyDrawing(self.menu:gradient({ikura.theme.accent, darken(ikura.theme.accent, 0.25)}, 3), {Position = toggle.buttonoutline.Position + v2(1, 1), Size = v2(9, 9), Color = default and ikura.theme.accent or ikura.theme.background, Visible = visible})
        toggle.text = self.menu:draw("Text", {Position = toggle.buttonoutline.Position + v2(16, -2), Size = 14, Color = ikura.theme.text, Text = text, Visible = visible}, "text")
        ...
        toggle.button:SetColor(not default and {ikura.theme.lightbackground, ikura.theme.background})
        return toggle
    end
    ...
    local function addSection(self, text)
        ...
        section.buttonoutline = self.menu:draw("Square", {Position = lastButton.Position + v2(lastButton.Size.X + 1, 0), Color = ikura.theme.outline, Visible = visible}, "outline")
        section.button = self.menu:draw("Square", {Position = section.buttonoutline.Position + v2(0, 0), Color = ikura.theme.hidden, Visible = visible}, "hidden")
        section.text = self.menu:draw("Text", {Size = 14, Color = ikura.theme.hiddenText, Center = true, Text = text, Visible = visible}, "text")
    ...
    local function createSection(self, text, right, height)
        ...
        section.outline = self.menu:draw("Square", {Size = v2(231, height), Position = self.menu.sectionbg.Position + v2(7 + (right and 235 or 0), 3 + self[side]), Color = ikura.theme.outline, Visible = visible}, "outline")
        section.highlightoutline = self.menu:draw("Square", {Size = v2(229, 4), Position = section.outline.Position + v2(1, 1), Color = ikura.theme.outline, Visible = visible}, "outline")
        section.highlight = modifyDrawing(self.menu:gradient({ikura.theme.accent:Lerp(Color3.new(1, 1, 1), 0.1), ikura.theme.accent, darken(ikura.theme.accent, 0.4)}, 3), {Size = v2(229, 3), Position = section.highlightoutline.Position, Color = ikura.theme.accent, Visible = visible})
        section.buttons = self.menu:draw("Square", {Size = v2(229, 20), Position = section.highlightoutline.Position + v2(0, 4), Color = ikura.theme.hidden, Visible = visible}, "hidden")
        section.buttonoutline = self.menu:draw("Square", {Position = section.highlightoutline.Position + v2(0, 4), Color = ikura.theme.outline, Visible = visible}, "outline")
        section.button = self.menu:draw("Square", {Position = section.highlightoutline.Position + v2(0, 4), Color = ikura.theme.background, Visible = visible}, "background")
        section.buttonbackground = modifyDrawing(self.menu:gradient({ikura.theme.lightbackground, ikura.theme.background}, 8), {Position = section.highlightoutline.Position + v2(0, 4), Color = ikura.theme.background, Visible = visible})
        section.text = self.menu:draw("Text", {Size = 14, Color = ikura.theme.text, Center = true, Text = text, Visible = visible}, "text")
        ...
        section.text.ZIndex = 3
        section.background = self.menu:draw("Square", {Size = v2(229, height - 27), Position = section.outline.Position + v2(1, 26), Color = ikura.theme.background, Visible = visible}, "background")
        section.menu = self.menu
        section.tab = self
        section.name = text
        ...
        local function updateListText()
            ...
            for playerIndex = 1, 9 do
                ...
                if player then
                    ...
                    playerdrawings.team.Color = isteamed and player.TeamColor.Color or ikura.theme.text
                    playerdrawings.status.Text = islocal and "Local Player" or status[player] or "None"
                    playerdrawings.status.Color = islocal and Color3.new(0.407843, 0, 0.87451) or ikura.theme.text
                end
            end
        end
    ...
    local function createPlayerList(self, statuslist, callbacks)
        ...
        playerlist.outline = self.menu:draw("Square", {Size = v2(231 + 235, height), Position = self.menu.sectionbg.Position + v2(7, 3), Color = ikura.theme.outline, Visible = visible}, "outline")
        playerlist.highlightoutline = self.menu:draw("Square", {Size = v2(229 + 235, 4), Position = playerlist.outline.Position + v2(1, 1), Color = ikura.theme.outline, Visible = visible}, "outline")
        playerlist.highlight = modifyDrawing(self.menu:gradient({ikura.theme.accent:Lerp(Color3.new(1, 1, 1), 0.1), ikura.theme.accent, darken(ikura.theme.accent, 0.4)}, 3), {Size = v2(229 + 235, 3), Position = playerlist.highlightoutline.Position, Color = ikura.theme.accent, Visible = visible})
        playerlist.buttons = self.menu:draw("Square", {Size = v2(229 + 235, 20), Position = playerlist.highlightoutline.Position + v2(0, 4), Color = ikura.theme.hidden, Visible = visible}, "hidden")
        playerlist.buttonoutline = self.menu:draw("Square", {Position = playerlist.highlightoutline.Position + v2(0, 4), Color = ikura.theme.outline, Visible = visible}, "outline")
        playerlist.button = self.menu:draw("Square", {Position = playerlist.highlightoutline.Position + v2(0, 4), Color = ikura.theme.background, Visible = visible}, "background")
        playerlist.buttonbackground = modifyDrawing(self.menu:gradient({ikura.theme.lightbackground, ikura.theme.background}, 8), {Position = playerlist.highlightoutline.Position + v2(0, 4), Color = ikura.theme.background, Visible = visible})
        playerlist.text = self.menu:draw("Text", {Size = 14, Color = ikura.theme.text, Center = true, Text = "Player List", Visible = visible}, "text")
        ...
        playerlist.background = self.menu:draw("Square", {Size = v2(229 + 235, height - 27), Position = playerlist.outline.Position + v2(1, 26), Color = ikura.theme.background, Visible = visible}, "background")
        playerlist.playerBoxOutline = self.menu:draw("Square", {Size = v2(229 + 235 - 16, 210), Position = playerlist.outline.Position + v2(9, 26 + 18), Color = ikura.theme.outline, Visible = visible}, "outline")
        playerlist.playerBoxBackground = self.menu:draw("Square", {Size = v2(229 + 235 - 16 - 2, 208), Position = playerlist.outline.Position + v2(10, 26 + 19), Color = ikura.theme.background, Visible = visible}, "background")
        playerlist.playerPFPOutline = self.menu:draw("Square", {Size = v2(74, 74), Position = playerlist.outline.Position + v2(9, 26 + 18 + 8 + 210), Color = ikura.theme.outline, Visible = visible}, "outline")
        ...
        --playerlist.playerPFP = self.menu:draw("Square", {Size = v2(72, 72), Position = playerlist.outline.Position + v2(10, 26 + 18 + 8 + 211), Color = ikura.theme.outline, Visible = visible}, "outline")
        playerlist.statusbuttonoutline = self.menu:draw("Square", {Size = v2(149, 20), Position = playerlist.outline.Position + v2(308, 26 + 18 + 210 + 22), Color = ikura.theme.outline, Visible = visible}, "outline")
        playerlist.statusbutton = modifyDrawing(self.menu:gradient({ikura.theme.lightbackground, ikura.theme.background}, 6), {Size = v2(147, 18), Position = playerlist.outline.Position + v2(309, 26 + 18 + 210 + 23), Visible = visible})
        playerlist.votekickbuttonoutline = self.menu:draw("Square", {Size = v2(69, 20), Position = playerlist.outline.Position + v2(308, 26 + 18 + 210 + 53), Color = ikura.theme.outline, Visible = visible}, "outline")
        playerlist.votekickbutton = modifyDrawing(self.menu:gradient({ikura.theme.lightbackground, ikura.theme.background}, 6), {Size = v2(67, 18), Position = playerlist.outline.Position + v2(309, 26 + 18 + 210 + 54), Visible = visible})
        playerlist.spectatebuttonoutline = self.menu:draw("Square", {Size = v2(69, 20), Position = playerlist.outline.Position + v2(308 + 80, 26 + 18 + 210 + 53), Color = ikura.theme.outline, Visible = visible}, "outline")
        playerlist.spectatebutton = modifyDrawing(self.menu:gradient({ikura.theme.lightbackground, ikura.theme.background}, 6), {Size = v2(67, 18), Position = playerlist.outline.Position + v2(308 + 81, 26 + 18 + 210 + 54), Visible = visible})

        playerlist.nametext = self.menu:draw("Text", {Position = playerlist.playerBoxOutline.Position + v2(4, -17), Size = 14, Color = ikura.theme.text, Text = "Name", Visible = visible}, "text")
        playerlist.teamtext = self.menu:draw("Text", {Position = playerlist.playerBoxOutline.Position + v2(4 + 148, -17), Size = 14, Color = ikura.theme.text, Text = "Team", Visible = visible}, "text")
        playerlist.statuslabeltext = self.menu:draw("Text", {Position = playerlist.playerBoxOutline.Position + v2(4 + 298, -17), Size = 14, Color = ikura.theme.text, Text = "Status", Visible = visible}, "text")
        playerlist.playertext = self.menu:draw("Text", {Position = playerlist.playerPFP.Position + v2(78, -2), Size = 14, Color = ikura.theme.text, Text = "No Player Selected", Visible = visible}, "text")
        playerlist.playerstatustext = self.menu:draw("Text", {Position = playerlist.statusbuttonoutline.Position + v2(-1, -17), Size = 14, Color = ikura.theme.text, Text = "Player Status", Visible = visible}, "text")
        playerlist.statustext = self.menu:draw("Text", {Position = playerlist.playerstatustext.Position + v2(6, 19), Size = 14, Color = ikura.theme.text, Text = "None", Visible = visible}, "text")
        playerlist.droptext = self.menu:draw("Text", {Position = playerlist.playerstatustext.Position + v2(137, 20), Size = 14, Color = ikura.theme.text, Text = "-", Visible = visible}, "text")
        playerlist.votekicktext = self.menu:draw("Text", {Position = playerlist.votekickbutton.Position + v2(33, 1), Size = 14, Center = true, Color = ikura.theme.text, Text = "Votekick", Visible = visible}, "text")
        playerlist.spectatetext = self.menu:draw("Text", {Position = playerlist.spectatebutton.Position + v2(33, 1), Size = 14, Center = true, Color = ikura.theme.text, Text = "Spectate", Visible = visible}, "text")

        playerlist.carrot = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(437, -1), Size = 14, Outline = false, Color = ikura.theme.accent, Text = "^", Visible = visible}, "accent")
        playerlist.tinyv = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(437, 195), Size = 11, Outline = false, Color = ikura.theme.accent, Text = "v", Visible = visible}, "accent")
        ...
        for playerIndex = 1, 9 do
            ...
            if playerIndex ~= 9 then
                drawinglist.sectionline = self.menu:draw("Square", {Size = v2(438, 1), Position = playerlist.playerBoxBackground.Position + v2(4, 23 * playerIndex), Color = ikura.theme.outline, Visible = visible}, "outline")
            end

            drawinglist.teamline = self.menu:draw("Square", {Size = v2(1, playerIndex ~= 9 and 16 or 17), Position = playerlist.playerBoxBackground.Position + v2(148, 23 * (playerIndex - 1) + 4), Color = ikura.theme.outline, Visible = visible}, "outline")
            drawinglist.statusline = self.menu:draw("Square", {Size = v2(1, playerIndex ~= 9 and 16 or 17), Position = playerlist.playerBoxBackground.Position + v2(298, 23 * (playerIndex - 1) + 4), Color = ikura.theme.outline, Visible = visible}, "outline")
            drawinglist.name = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(4, 23 * (playerIndex - 1) + 5), Size = 14, Color = ikura.theme.text, Text = "", Visible = visible}, "text")
            drawinglist.team = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(152, 23 * (playerIndex - 1) + 5), Size = 14, Color = ikura.theme.text, Text = "", Visible = visible}, "text")
            drawinglist.status = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(302, 23 * (playerIndex - 1) + 5), Size = 14, Color = ikura.theme.text, Text = "", Visible = visible}, "text")
    ...
    local function createTab(self, text)
        ...
        tab.title = self:draw("Text", {Size = 15, Position = tab.button.Position + v2(48, 11), Color = ikura.theme[tab.tabIndex == self.tabIndex and "text" or "hiddenText"], Text = text, Center = true, Visible = self.open}, "text")
    ...
    local function createKeyList(self, includeKeyName)
        ...
        keys.outline = keys:draw("Square", {Color = ikura.theme.outline, Visible = true}, "outline")
        keys.background = keys:draw("Square", {Color = ikura.theme.background, Visible = true}, "background")
        keys.titlebackground = modifyDrawing(keys:gradient({ikura.theme.lightbackground, ikura.theme.background}, 7), {Color = ikura.theme.accent, Visible = true})
        keys.highlightoutline = keys:draw("Square", {Color = ikura.theme.outline, Visible = true}, "outline")
        keys.highlight = modifyDrawing(keys:gradient({ikura.theme.accent:Lerp(Color3.new(1, 1, 1), 0.1), ikura.theme.accent, darken(ikura.theme.accent, 0.4)}, 3), {Color = ikura.theme.accent, Visible = true})
        keys.title = keys:draw("Text", {Size = 16, Color = ikura.theme.text, Text = "Keybinds", Visible = true}, "text")
        ...
        local function updateKeybinds()
            ...
            for _, keyData in self.keybinds do
                ...
                insert(newkeybinds, {keys:draw("Text", {Size = 16, Color = ikura.theme.text, Text = text, Visible = true}, "text"), keybind})
            end
    ...
    function ikura:CreateMenu(title, visible, index)
        if visible == nil then
            visible = true
        end
        ...
        if input.KeyCode ~= Enum.KeyCode.Unknown then
            ...
            if typing then
                ...
                elseif key == "V" and (userInputService:IsKeyDown(Enum.KeyCode.LeftControl) or userInputService:IsKeyDown(Enum.KeyCode.RightControl)) and keypress and keyrelease then
                    task.spawn(function()
                        local screenGui = Instance.new("ScreenGui", game.CoreGui) -- hello?
                        local textBox = Instance.new("TextBox", screenGui) --  ok
            ...
            for _, menuData in ikura.menus do
            ...
            if input.KeyCode == Enum.KeyCode[ikura.toggleKeybind] and clockTime - lastToggle > fadeDuration * 2 and not dragging and not sliding and not dropping and not picking then
                ikura.open = not ikura.open
                lastToggle = clockTime

                for _, menu in ikura.menus do
                    local trans = (ikura.open and 0 or 1) --menu.background.Transparency
                    local stepFactor = 1 / fadeSteps
                    local step = stepFactor * (ikura.open and 1 or -1)
                    ...
                    if onInside then
                        ...
                        if mouse.Y < sectionbg.Y then
                            if clicked then
                                ...
                                oldTab.title.Color = ikura.theme.hiddenText
                                newTab.title.Color = ikura.theme.text
                                ...
                                oldButton.Color = ikura.theme.hidden
                                newButton.Color = ikura.theme.background
                                        ...
                                        if sectionData.selected then
                                            ...
                                            if checkDrawing(mouse, statusButton) then
                                                ...
                                                for statusIndex = 1, #sectionData.statuslist + 1 do
                                                    ...
                                                    buttonData.outline = statusdropping:draw("Square", {Size = v2(149, 20), Position = statusButton.Position + v2(0, 19 * statusIndex), Color = ikura.theme.outline, Visible = true, ZIndex = 4}, "outline")
                                                    buttonData.button = statusdropping:draw("Square", {Size = v2(147, 18), Position = buttonData.outline.Position + v2(1, 1), Color = ikura.theme.background, Visible = true, ZIndex = 4}, "outline")
                                                    buttonData.text = statusdropping:draw("Text", {Position = buttonData.button.Position + v2(4, 1), Size = 14, Color = ikura.theme.text, Text = statusName, Visible = true, ZIndex = 4}, "text")
                                        ...
                                        if clicked then
                                            for sectionIndex, section in sectionData.sections do
                                                if checkDrawing(mouse, section.button) then
                                                    ...
                                                    oldSec.text.Color = ikura.theme.hiddenText
                                                    section.text.Color = ikura.theme.text
                                                    oldSec.button.Size = oldSec.button.Size - v2(0, 1)
                                                    section.button.Size = section.button.Size + v2(0, 1)
                                                    oldSec.button.Color = ikura.theme.hidden
                                                    section.button.Color = ikura.theme.background
                                                ...
                                                if checkBounds(relPos - v2(0, height), v2(230, element.height)) then
                                                    if element.type == "toggle" then
                                                        ...
                                                        for _, color in element.colors do
                                                            if checkDrawing(mouse, color.buttonoutline) then
                                                                ...
                                                                picker.outline = picker:draw("Square", {Position = color.toggle.buttonoutline.Position + v2(-57, -8), Size = v2(275, 217), Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                                picker.background = picker:draw("Square", {Position = picker.outline.Position + v2(1, 1), Size = v2(273, 215), Color = ikura.theme.background, Visible = true, ZIndex = 4})
                                                                picker.highlightbackground = picker:draw("Square", {Position = picker.outline.Position + v2(1, 1), Size = v2(273, 4), Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                                picker.highlight = modifyDrawing(picker:gradient({ikura.theme.accent:Lerp(Color3.new(1, 1, 1), 0.1), ikura.theme.accent, darken(ikura.theme.accent, 0.4)}, 3), {Position = picker.highlightbackground.Position, Size = v2(273, 3), Visible = true, ZIndex = 4})
                                                                picker.titlebackground = modifyDrawing(picker:gradient({ikura.theme.lightbackground, ikura.theme.background}, 6), {Size = v2(273, 17), Position = picker.background.Position + v2(0, 4), Visible = true, ZIndex = 4})
                                                                picker.title = picker:draw("Text", {Position = picker.background.Position + v2(3, 3), Size = 14, Color = ikura.theme.text, Text = color.name, Visible = true, ZIndex = 4})
                                                                picker.hsvOutline = picker:draw("Square", {Position = picker.background.Position + v2(7, 19), Size = v2(202 - 18 - 16, 168), Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                                picker.hueOutline = picker:draw("Square", {Position = picker.hsvOutline.Position + v2(7 + picker.hsvOutline.Size.X, 0), Size = v2(12, 168), Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.valueOutline = picker:draw("Square", {Position = picker.background.Position + v2(7, 195), Size = v2(202 - 18 - 16, 12), Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.newtext = picker:draw("Text", {Position = picker.hueOutline.Position + v2(19, -2), Size = 14, Color = ikura.theme.text, Text = "New Color", Visible = true, ZIndex = 4})
                                                                picker.newOutline = picker:draw("Square", {Position = picker.newtext.Position + v2(0, 17), Size = v2(65, 35), Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.oldtext = picker:draw("Text", {Position = picker.hueOutline.Position + v2(19, 52), Size = 14, Color = ikura.theme.text, Text = "Old Color", Visible = true, ZIndex = 4})
                                                                picker.oldOutline = picker:draw("Square", {Position = picker.oldtext.Position + v2(0, 17), Size = v2(65, 35), Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.applytext = picker:draw("Text", {Position = picker.hueOutline.Position + v2(27, 175), Size = 14, Color = ikura.theme.text, Text = "[  Apply  ]", Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.hsvButtonOutline = picker:draw("Square", {Position = startPos + v2(s * 166 - 2, (1 - v) * 166 - 2), Size = v2(5, 5), Filled = false, Thickness = 1, Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.hueButtonOutline = picker:draw("Square", {Position = picker.hue.Position + v2(-3, (1 - h) * 166 - 3), Size = v2(16, 5), Filled = false, Thickness = 1, Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.valueButtonOutline = picker:draw("Square", {Position = picker.valuebar.Position + v2(v * 166 - 3, -3), Size = v2(5, 16), Filled = false, Thickness = 1, Color = ikura.theme.outline, Visible = true, ZIndex = 4})
                                                    ...
                                                    elseif element.type == "dropdown" then
                                                        ...
                                                        for optionIndex = 1, #element.options do
                                                            local newDrawings = {}
                                                            newDrawings.outline = menuData:draw("Square", {Position = element.buttonoutline.Position + v2(0, optionIndex * 17), Size = v2(213, 18), Color = ikura.theme.outline, Visible = true, ZIndex = 4}, "outline")
                                                            newDrawings.button = menuData:draw("Square", {Position = newDrawings.outline.Position + v2(1, 1), Size = v2(211, 16), Color = ikura.theme.background, Visible = true, ZIndex = 4}, "background")
                                                            newDrawings.valuetext = menuData:draw("Text", {Position = newDrawings.button.Position + v2(6, 0), Size = 14, Color = ikura.theme.text, Text = element.options[optionIndex], Visible = true, ZIndex = 4}, "text")
...
LPH_JIT_MAX(function() -- Main Cheat
    ...
    local pathfinding = loadstring(game:HttpGet("https://raw.githubusercontent.com/ikuraxc4/ikuraxcok/refs/heads/main/pathfinding.lua"))() -- i didnt make this, i did fix it tho
    ...
    local function scanPositions(origin, target, accel, speed, penetration)
        local origins = getPositionOffsets(origin, target, ikura:GetValue("Rage Bot", "Fire Position Scanning") and ikura:GetValue("Rage Bot", "Fire Position Offset"))
        local targets = getPositionOffsets(target, origin, ikura:GetValue("Rage Bot", "Hit Position Scanning") and ikura:GetValue("Rage Bot", "Hit Position Offset"))
    ...
    local function applyAAAngles(angles)
        ...
        if ikura:GetValue("Anti Aim", "Pitch") then
            local addition = rad(ikura:GetValue("Anti Aim", "Pitch Amount")) - quarter

            if string.find(string.lower(ikura:GetValue("Anti Aim", "Pitch Mode")), "abs") then
                x = addition
            else
                x += addition
            end
        ...
        if ikura:GetValue("Anti Aim", "Yaw") then
            local addition = rad(ikura:GetValue("Anti Aim", "Yaw Amount"))

            if string.find(string.lower(ikura:GetValue("Anti Aim", "Yaw Mode")), "rel") then
                y += addition
            else
                y = addition
            end
        ...
        if ikura:GetValue("Anti Aim", "Spin Bot") then
            y += (os.clock() - startTime) * math.rad(ikura:GetValue("Anti Aim", "Spin Speed")) * ((ikura:GetValue("Anti Aim", "Spin Direction") == "Left" and 1) or -1)
        end
    ...
    function network:send(name, ...)
        if ikura:GetValue("Third Person", "Enabled") and ikura:GetValue("Third Person", "Show Character") then
            if name == "spawn" then
                if not started then
                    started = true
                end
            ...
            if currentObj then
                ...
                elseif name == "stance" then
                    ...
                    if (not ikura:GetValue("Anti Aim", "Enabled (May Cause Despawning)") or not ikura:GetValue("Anti Aim", "Force Stance") or not ikura:GetValue("Third Person", "Apply Anti Aim To Character")) and currentObj then
        ...
        elseif name == "repupdate" then
            ...
            if teleporting then -- pf devs noooooo
                if not teleportData.time then -- ok
            ...
            if newSpawnCache.noclipping then -- this is fried and i broke it somehow
                ...
                return
            elseif ikura:GetValue("Movement", "Noclip") and newSpawnCache.lastUpdate then
            ...
            if ikura:GetValue("Anti Aim", "Enabled (May Cause Despawning)") then
                angles = applyAAAngles(angles)
                angles2 = angles * 0.99
            end
            
            --if ikura:GetValue("Rage Bot", "Enabled") and ikura:GetValue("Rage Bot", "Firerate (May Cause Kicking)") then
            ...
            local fly = false --ikura:GetValue("Movement", "Fly") or (ikura:GetValue("Rage Bot", "Enabled") and ikura:GetValue("Rage Bot", "Firerate (May Cause Kicking)"))
            ...
            if ikura:GetValue("Movement", "Walk Speed") and newSpawnCache.lastUpdate then -- no patch pls :(
                send(self, name, newSpawnCache.lastUpdate, angles, angles2, time + newSpawnCache.latency + newSpawnCache.currentAddition)
                newSpawnCache.updateDebt += 1
            end
        ...
        elseif name == "newbullets" then
            ...
            if ikura:GetValue("Rage Bot", "Enabled") then
                return
            end

            if ikura:GetValue("Silent Aim", "Enabled") and (ikura:GetValue("Silent Aim", "Hit Chance") >= chanceOne) then
                local target, entry, part = getClosest(silentaimfov.Position, ikura:GetValue("Silent Aim", "Use FOV") and silentaimfov.Radius, ikura:GetValue("Silent Aim", "Use Dead FOV") and silentaimdeadfov.Radius, ikura:GetValue("Silent Aim", "Visible Check"), (ikura:GetValue("Silent Aim", "Head Shot Chance") >= chanceTwo) and "Head" or "Torso")
        ...
        elseif name == "falldamage" and ikura:GetValue("Movement", "No Fall Damage") then
            return
        elseif name == "stance" then
        ...
        elseif timeUpdates[name] then
            ...
            if name == "equip" then
                ...
                if ikura:GetValue("Knife Bot", "Kill All (May Despawn)") and not ikura:GetValue("Knife Bot", "Only When Holding Knife") then
                    args[1] = 3
                end
            end
        ...
        elseif name == "ping" then
            ...
            --if ikura:GetValue("Rage Bot", "Enabled") and ikura:GetValue("Rage Bot", "Firerate (May Cause Kicking)") then -- idk if this needs to be here i think it helps a little
        ...
        if ikura:GetValue("Anti Aim", "Enabled (May Cause Despawning)") then
            if name == "stance" and ikura:GetValue("Anti Aim", "Force Stance") then
                local stance = ...
                stance = string.lower(ikura:GetValue("Anti Aim", "Set Stance"))

                if ikura:GetValue("Third Person", "Apply Anti Aim To Character") and currentObj then
                    currentObj:setStance(stance)
                end
    ...
    screenCull.step = LPH_NO_VIRTUALIZE(function(...)
        ...
        if ikura:GetValue("Third Person", "Enabled") then
            local controller = weaponInterface.getActiveWeaponController()

            if controller and (ikura:GetValue("Third Person", "Show Character While Aiming") or not controller:getActiveWeapon()._aiming) then
                local cameraOffset = Vector3.new(ikura:GetValue("Third Person", "Camera Offset X"), ikura:GetValue("Third Person", "Camera Offset Y"), ikura:GetValue("Third Person", "Camera Offset Z"))
                local didHit = false

                if ikura:GetValue("Third Person", "Camera Offset Always Visible") then
    ...
    function bulletObject.new(bulletData)
        if bulletData.onplayerhit then
            ...
            if ikura:GetValue("World Visuals", "Bullet Tracers") or ikura:GetValue("World Visuals", "Impact Points") then
                local frames, hits = simulateBullet(bulletData.position, bulletData.velocity, bulletData.penetrationdepth)

                if ikura:GetValue("World Visuals", "Bullet Tracers") then
                    local endColor = ikura:GetValue("World Visuals", "Color One")
                    local startColor = ikura:GetValue("World Visuals", "Color Two")
                    local diameter = ikura:GetValue("World Visuals", "Tracers Size")
                    ...
                    for frame = 1, frameCount do -- god damn perfect bullet tracers
                        ...
                        tracer.Material = Enum.Material[ikura:GetValue("World Visuals", "Tracers Material")]
                        tracer.Transparency = ikura:GetValue("World Visuals", "Tracers Transparency") * 0.01
                        ...
                        task.delay(ikura:GetValue("World Visuals", "Duration"), function()
                ...
                if ikura:GetValue("World Visuals", "Impact Points") then
                    for wall = 1, #hits do
                        local point = Instance.new("Part")
                        point.Material = Enum.Material[ikura:GetValue("World Visuals", "Points Material")]
                        point.Transparency = ikura:GetValue("World Visuals", "Points Transparency") * 0.01
                        point.Anchored = true
                        point.CanCollide = false
                        point.Color = ikura:GetValue("World Visuals", "Points Color")
            ...
            if ikura:GetValue("Backtracking", "Enabled") or ikura:GetValue("Hit Boxes", "Enabled") then
                ...
                bulletData.ontouch = function(self, part, position, normal, exit, exitnorm) -- goated hitbox method
                    if not ticketCache[extra.bulletTicket] then
                        if ikura:GetValue("Hit Boxes", "Enabled") and part:IsDescendantOf(hitboxObjects) then
                            ticketCache[extra.bulletTicket] = true
                            send(network, "bullethit", extra.uniqueId, players[part.Name], position, ikura:GetValue("Hit Boxes", "Hit Part"), extra.bulletTicket + ticketAddition, network.getTime() + newSpawnCache.latency + newSpawnCache.currentAddition)
                        elseif ikura:GetValue("Backtracking", "Enabled") and part:IsDescendantOf(backtrackObjects) then
                            local model = part
    ...
    function hudScopeInterface.updateScope(...)
        if ikura:GetValue("Gun Mods", "No Sniper Scope") then -- more scripts need this
    ...
    function recoil.applyImpulse(...)
        if aimbotting or ikura:GetValue("Gun Mods", "No Recoil") then
            return
        end
    ...
    function firearmObject:reload()
        if ikura:GetValue("Gun Mods", "Instant Reload") and self._spareCount > 0 then
    ...
    function firearmObject:computeWalkSway(dy, dx)
        if ikura:GetValue("Gun Mods", "No Walk Sway") or aimbotting then
            dy = 0
            dx = 0
        end
    ...
    function firearmObject.computeGunSway(...)
        if ikura:GetValue("Gun Mods", "No Gun Sway") or aimbotting then
    ...
    function cframeLib.fromAxisAngle(x, y, z) -- luh freak
        if aimbotting then -- or ikura:GetValue("Gun Mods", "No Camera Sway") then
            local controller = weaponInterface.getActiveWeaponController()
            local weapon = controller and controller:getActiveWeapon()
    ...
    function modifyData.getModifiedData(data, ...)
        ...
        if ikura:GetValue("Gun Mods", "No Spread") then
            data.hipfirespread = 0
            data.hipfirestability = 99999
            data.hipfirespreadrecover = 99999
        end

        if ikura:GetValue("Gun Mods", "Small Crosshair") then
            data.crosssize = 10
        ...
        if ikura:GetValue("Gun Mods", "No Crosshair") then
    ...
    cameraObject.step = LPH_NO_VIRTUALIZE(function(self, dt)
        if aimbotting or ikura:GetValue("Gun Mods", "No Camera Sway") then
            mainStep(self, 0)
            self._lookDt = dt
            return
        end
...
--[[ synz has upval instability
    ...
    debug.setupvalue(cameraObject.step, 2, {fromAxisAngle = function(...)
        return (aimbotting or ikura:GetValue("Gun Mods", "No Camera Sway")) and CFrame.identity or cframeLib.fromAxisAngle(...)
    ...
    function audioSystem.playSoundId(assetId, priority, volume, pitch, part, maxPartDist, pitchRange, randomPitch, emitterSize, rollOffMode, playOnRemove, looped)
        if ikura:GetValue("Sounds", "Shoot Sound") ~= "None" then
            local controller = weaponInterface.getActiveWeaponController()
            local weapon = controller and controller:getActiveWeapon()

            if weapon and assetId == weapon:getWeaponStat("firesoundid") then
                return playSoundId(customAudios[ikura:GetValue("Sounds", "Shoot Sound")], priority, volume)
            end
        end
    ...
    function audioSystem.playSound(soundName, ...)
        ...
        if ikura:GetValue("Sounds", "Hit Sound") ~= "None" and soundName == "hitmarker" then
            return playSoundId(customAudios[ikura:GetValue("Sounds", "Hit Sound")], 1, args[3])
        elseif ikura:GetValue("Sounds", "Footstep Sound") ~= "None" and (args[1] == "SelfFoley") then
            return playSoundId(customAudios[ikura:GetValue("Sounds", "Footstep Sound")], args[2], args[3])
        elseif ikura:GetValue("Sounds", "Kill Sound") ~= "None" and (soundName == "killshot" or soundName == "headshotkill") then
            return playSoundId(customAudios[ikura:GetValue("Sounds", "Kill Sound")], 1, args[3])
        elseif ikura:GetValue("Sounds", "Got Hit Sound") ~= "None" and (soundName == "crackSmall" or soundName == "crackBig") then
            return playSoundId(customAudios[ikura:GetValue("Sounds", "Got Hit Sound")], 1, args[3])
        end
    ...
    function effects.breakwindow(part, receiveWindow, netTime)
        if part.Name ~= "Window" then
            return
        elseif ikura:GetValue("Sounds", "Glass Breaking Sound") ~= "None" then
                ...
                if child.ClassName == "Part" and child.CFrame == part.CFrame then
                    child.ChildAdded:Connect(function(sound)
                        if sound.ClassName == "Sound" then
                            sound.SoundId = customAudios[ikura:GetValue("Sounds", "Glass Breaking Sound")] or ""
                        end
                    end)
                end
            end)
    ...
    function charObject:setBaseWalkSpeed(speed)
        ...
        return setBaseWalkSpeed(self, ikura:GetValue("Movement", "Walk Speed") and ikura:GetValue("Movement", "Set Speed") or speed)
    end

    local jump = charObject.jump
    function charObject:jump(height, vaulting)
        return jump(self, 4 + (ikura:GetValue("Movement", "Jump Power") and ikura:GetValue("Movement", "Height Addition") or 0), vaulting)
    end
    ...
    callbackList["Movement%%Walk Speed"] = function(state)
        if charInterface.isAlive() then
            ...
            if state then
                setBaseWalkSpeed(object, ikura:GetValue("Movement", "Set Speed"))
            else
    ...
    callbackList["Tweaks%%Custom Kill Notification"] = function(state)
        hudnotify.typeList.kill[1] = state and ikura:GetValue("Tweaks", "Notification Text") or "Enemy Killed!"
    end

    callbackList["Tweaks%%Notification Text"] = function(state)
        if ikura:GetValue("Tweaks", "Custom Kill Notification") then
    ...
    callbackList["Anti Aim%%Enabled (May Cause Despawning)"] = function(state)
        ...
        if charInterface.isAlive() then
            if ikura:GetValue("Third Person", "Show Character") and ikura:GetValue("Third Person", "Apply Anti Aim To Character") and currentObj then
                if ikura:GetValue("Anti Aim", "Force Stance") then
                    local stance = state and ikura:GetValue("Anti Aim", "Set Stance") or newSpawnCache.stance or "stand"
                    currentObj:setStance(stance)
                end

                if ikura:GetValue("Anti Aim", "Jitter") then
            ...
            if ikura:GetValue("Anti Aim", "Jitter") and not state then
    ...
    callbackList["Third Person%%Enabled"] = function(state)
        if charInterface.isAlive() and ikura:GetValue("Third Person", "Show Character") then
            if state then
                started = true
            else
    ...
    --    if ikura:GetValue("Movement", "Noclip") and ref.ClassName == "Model" then
    ...
    local function updateCrosshair()
        local enabled = ikura:GetValue("Crosshair", "Enabled")
        crossdot.Visible = enabled and ikura:GetValue("Crosshair", "Show Dot")
        ...
        if not ikura:GetValue("Crosshair", "Rainbow Crosshair") then
            local color = ikura:GetValue("Crosshair", "Crosshair Color")
    ...
    local function updateCrosshairPos(force) -- i didnt want to make this
        local barrel = ikura:GetValue("Crosshair", "Follow Recoil") and getBarrelLocation()
        ...
        local sx = ikura:GetValue("Crosshair", "X Space") * 0.5
        local sy = ikura:GetValue("Crosshair", "Y Space") * 0.5
        local w = ikura:GetValue("Crosshair", "X Size")
        local h = ikura:GetValue("Crosshair", "Y Size")
        local speed = ikura:GetValue("Crosshair", "Spin Speed")
    ...
    table.insert(connectionList, camera.ChildAdded:Connect(function(model)
        if model.ClassName == "Model" then
            ...
            if ikura:GetValue("Chams", prefix .. "Chams") then
                local properties, uncache = cham.new(model, {
                    Material = Enum.Material[ikura:GetValue("Chams", prefix .. "Material")],
                    Transparency = ikura:GetValue("Chams", prefix .. "Transparency") * 0.01,
                    Color = ikura:GetValue("Chams", prefix .. "Color")
                }, false, true, false)
    ...
    function networkConnections.startvotekick(username, delay, votes)
        if ikura:GetValue("Server Hopper", "Server Hop On Votekick") and username == localPlayer.Name then -- this should work mf
            hopServers()
        end
    ...
    local function chatSpam() -- idk why this doesnt work on some exploits
        if ikura:GetValue("Chat Spam", "Enabled") then
            local list = chatSpamLists[ikura:GetValue("Chat Spam", "Spam List")]
            ...
            network:send("sendChatMessage", list[newSpamIndex], ikura:GetValue("Chat Spam", "Team Chat"))
            lastSpamIndex = newSpamIndex
        end

        task.delay(ikura:GetValue("Chat Spam", "Spam Delay"), chatSpam)
    end
    ...
    local function initKnifeBot()
        ...
        while raging do -- i ran out of amphetamines
            ...
            if root then
                ...
                if newSpawnCache.spawned and newSpawnCache.lastUpdate and (clock - newSpawnCache.spawnTime) > 1 and (nextScan - clock) <= 0 and not roundSystem.roundLock and ((not ikura:GetValue("Knife Bot", "Only When Holding Knife")) or (newSpawnCache.slot == 3)) then
                    local closestCharacters = getClosestPlayers(newSpawnCache.lastUpdate, true, ikura:GetValue("Knife Bot", "Only Kill Target Status"), ikura:GetValue("Knife Bot", "Whitelist Friendly Status"))
    ...
    callbackList["Knife Bot%%Kill All (May Despawn)"] = function(state)
        ...
        if charInterface.isAlive() then
            if not ikura:GetValue("Knife Bot", "Only When Holding Knife") and newSpawnCache.slot ~= 3 then
                if state then
    ...
    callbackList["Knife Bot%%Only When Holding Knife"] = function(state)
        if ikura:GetValue("Knife Bot", "Kill All (May Despawn)") and charInterface.isAlive() and newSpawnCache.slot ~= 3 then
            if state then
                send(network, "equip", newSpawnCache.slot, network.getTime() + newSpawnCache.latency + newSpawnCache.currentAddition)
            else
                send(network, "equip", 3, network.getTime() + newSpawnCache.latency + newSpawnCache.currentAddition)
    ...
    callbackList["Custom Model%%Asset ID"] = function(state)
        if ikura:GetValue("Custom Model", "Custom Character Model") then
            if customModel then
    ...
    callbackList["Custom Model%%Asset ID"](ikura:GetValue("Custom Model", "Asset ID"))
    ...
    table.insert(connectionList, runService.Heartbeat:Connect(LPH_NO_VIRTUALIZE(function(ndt)
        ...
        if controller and weapon then
            local isHidden = (hidden or weapon._blackScoped or ((ikura:GetValue("Third Person", "Enabled") and ikura:GetValue("Third Person", "Show Character")) and (ikura:GetValue("Third Person", "Show Character While Aiming") or not aiming)))
            if isHidden then
        ...
        if customModel and rootPart then
            local part = customModel.ClassName == "Model" and customModel.PrimaryPart or customModel
            customModel.CFrame = rootPart.CFrame * CFrame.new(ikura:GetValue("Custom Model", "Asset Offset X"), ikura:GetValue("Custom Model", "Asset Offset Y"), ikura:GetValue("Custom Model", "Asset Offset Z"))
        end
            ...
            if rootPart then
                ...
                if currentObj or started then
                    if started then
                        ...
                        if ikura:GetValue("More Chams", "Third Person Character Chams") then
                            task.delay(0.15, function()
                                local _, uncache = cham.new(currentObj._character, {
                                    Transparency = ikura:GetValue("More Chams", "Character Transparency") * 0.01,
                                    Material = Enum.Material[ikura:GetValue("More Chams", "Character Material")],
                                    Color = ikura:GetValue("More Chams", "Character Color")
                                }, false, true, false)
                                objectChamUncache = uncache
                            end)
                        end

                        if ikura:GetValue("Anti Aim", "Enabled (May Cause Despawning)") and ikura:GetValue("Anti Aim", "Force Stance") and ikura:GetValue("Third Person", "Apply Anti Aim To Character") and currentObj then
                            currentObj:setStance(string.lower(ikura:GetValue("Anti Aim", "Set Stance")))
                        end
                    end
                    
                    local angles = cameraInterface:getActiveCamera():getAngles()
                    if ikura:GetValue("Anti Aim", "Enabled (May Cause Despawning)") and ikura:GetValue("Third Person", "Apply Anti Aim To Character") then
                        angles = applyAAAngles(angles)
                    end
                    ...
                    if not ikura:GetValue("Third Person", "Show Character While Aiming") and controller and aiming then
        ...
        if ikura:GetValue("Anti Aim", "Enabled (May Cause Despawning)") and ikura:GetValue("Anti Aim", "Jitter") and rootPart and (clockTime - lastJitter) > (1 / ikura:GetValue("Anti Aim", "Jitter Speed") / 2) then
        ...
        if ikura:GetValue("Movement", "Bunny Hop") and rootPart and (not ikura:GetValue("Movement", "Only While Jumping") or userInputService:IsKeyDown(Enum.KeyCode.Space)) then
            currentCharObject._lastJumpTime = 0
            currentCharObject:jump(4 + (ikura:GetValue("Movement", "Jump Power") and ikura:GetValue("Movement", "Height Addition") or 0))
        end

        if ikura:GetValue("Movement", "Noclip") and rootPart then
        ...
        if false then --ikura:GetValue("Movement", "Fly") and rootPart then
            ...
            if direction == Vector3.zero then
                ...
                rootPart.Anchored = false
                rootPart.Velocity = direction.Unit * ikura:GetValue("Movement", "Fly Speed")
            end
        end

        if ikura:GetValue("Hit Boxes", "Enabled") then
            replicationInterface.operateOnAllEntries(function(player, entry)
                if player.Team ~= localplayer.Team then
                    ...
                    if entry._receivedPosition then
                        if not sphere then
                            local size = ikura:GetValue("Hit Boxes", "Size")
                            sphere = Instance.new("Part")
                            sphere.Name = player.Name
                            sphere.CanCollide = true
                            sphere.Shape = Enum.PartType.Ball
                            sphere.Size = Vector3.new(size, size, size)
                            sphere.Material = Enum.Material[ikura:GetValue("Hit Boxes", "Material")]
                            sphere.Transparency = ikura:GetValue("Hit Boxes", "Transparency") * 0.01
                            sphere.Color = ikura:GetValue("Hit Boxes", "Color")
        ...
        if ikura:GetValue("Backtracking", "Enabled") then
            local delay = 1 / ikura:GetValue("Backtracking", "Refresh Rate")
            ...
            if clockTime > backtrackTime + delay then
                replicationInterface.operateOnAllEntries(function(player, entry)
                    ...
                    if player.Team ~= localplayer.Team and character then
                        ...
                        if ikura:GetValue("Backtracking", "Clone Character") then
                        ...
                        local properties = {
                            Material = Enum.Material[ikura:GetValue("Backtracking", "Character Material")],
                            Transparency = ikura:GetValue("Backtracking", "Character Transparency") * 0.01,
                            Color = ikura:GetValue("Backtracking", "Character Color"),
                            CanCollide = true
                        }
                        ...
                        task.delay(ikura:GetValue("Backtracking", "Character Duration"), function()
        ...
        if ikura:GetValue("Rage Bot", "Enabled") and clockTime > nextShot and not roundSystem.roundLock and not ikura:GetValue("Knife Bot", "Kill All (May Despawn)") then --  and newSpawnCache.hasPinged
            ...
            if weapon and weapon._weaponData and newSpawnCache.lastUpdate and not teleporting then
                local origin = newSpawnCache.lastUpdate
                local closestPlayers = getClosestPlayers(origin, false, ikura:GetValue("Rage Bot", "Only Shoot Target Status"), ikura:GetValue("Rage Bot", "Whitelist Friendly Status"))
                ...
                if closestPlayers and penetration and speed and (weapon._magCount > 0 or weapon._spareCount > 0) then
                    for playerIndex = 1, #closestPlayers do
                        ...
                        if newOrigin then
                            ...
                            if ikura:GetValue("Rage Bot", "Shoot Effects") and weapon._barrelPart then
                            ...
                            --if ikura:GetValue("Rage Bot", "Firerate (May Cause Kicking)") then
    ...
    table.insert(connectionList, runService.RenderStepped:Connect(LPH_NO_VIRTUALIZE(function(deltaTime)
        ...
        aimbotting = false
        if ikura:GetValue("Aim Bot", "Enabled") and aiming then
            local target, entry, part = getClosest(aimbotfov.Position, ikura:GetValue("Aim Bot", "Use FOV") and aimbotfov.Radius, ikura:GetValue("Aim Bot", "Use Dead FOV") and aimbotdeadfov.Radius, ikura:GetValue("Aim Bot", "Visible Check"), ikura:GetValue("Aim Bot", "Target Part"))
            ...
            if target and movementCache.position[entry._player][15] then
                ...
                local smoothing = ikura:GetValue("Aim Bot", "Smoothness")
        ...
        local circlePos
        if ikura:GetValue("FOV Settings", "FOV Follows Recoil") then
        ...
        if ikura:GetValue("FOV Settings", "Dynamic FOV") then
            local factor = not charInterface.isAlive() and 1 or (cameraInterface.getActiveCamera():getBaseFov() / camera.FieldOfView)
            aimbotfov.Radius = ikura:GetValue("Aim Bot", "FOV Radius") * factor
            aimbotdeadfov.Radius = ikura:GetValue("Aim Bot", "Dead FOV Radius") * factor
            silentaimfov.Radius = ikura:GetValue("Silent Aim", "FOV Radius") * factor
            silentaimdeadfov.Radius = ikura:GetValue("Silent Aim", "Dead FOV Radius") * factor
        end

        if ikura:GetValue("World Visuals", "Ambient") then
            local color = ikura:GetValue("World Visuals", "Ambient Color")
            lighting.Ambient = color
            lighting.OutdoorAmbient = color
        end

        if ikura:GetValue("Crosshair", "Enabled") then
            if (ikura:GetValue("Crosshair", "Spin Speed") > 0) or ikura:GetValue("Crosshair", "Follow Recoil") then
                updateCrosshairPos()
            end

            if ikura:GetValue("Crosshair", "Rainbow Crosshair") then
                local rainbow = Color3.fromHSV((clockTime * ikura:GetValue("Crosshair", "Rainbow Speed")) % 1, 1, 1)
...
LPH_NO_VIRTUALIZE(function() -- Make UI
    ...
    if isfile(folderName .. "/theme.json") then
        ...
        title = (userThemeData.Title == "ikura" and "ikura") or userThemeData.Title
        ikura.theme = {
    ...
    local menu = ikura:CreateMenu(title or defaultUIName, (not cacheExists) or devMode or uiCache.open, cacheExists and uiCache.index or 1)
    ikura.GetValue = menu.GetValue
    ikura.sectionIndexes = menu.sectionIndexes
    ...
    local legit = menu:CreateTab("Legit Mode")
    local rage = menu:CreateTab("Rage Mode")
    local visuals = menu:CreateTab("Visuals")
    local misc = menu:CreateTab("Misc")
    local settings = menu:CreateTab("Settings")

    local aimbot = legit:CreateSection("AimBot", false, "half")
    local fovsettings = aimbot:AddSection("FOV Settings", false, "half")
    local silentaim = legit:CreateSection("Silent Aim", true, "half")
    local backtrack = legit:CreateSection("Backtrack", false, "half")
    local hitboxes = backtrack:AddSection("Hit Box Expander")
    local gunmods = legit:CreateSection("Gun Modifications", true, "half")
    ...
    cheatSettings:AddButton("Unload", function()
        ...
        for _, drawingFolder in game:GetService("CoreGui"):GetChildren() do
            if drawingFolder.Name == "Drawing API By Ikura" then
